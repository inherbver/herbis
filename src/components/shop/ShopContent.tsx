      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1">
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <button className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-3 text-sm font-medium w-full mt-6">
              ...
              <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-3 text-sm font-medium">
                      Ajouter au panier
                    </button>
                  </div>
                </div>
