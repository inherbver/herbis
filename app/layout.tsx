        ...
        <div className="flex flex-col min-h-screen">
              ...
              <div className="flex justify-between items-center">
                <div>
                  <Link href="/" className="flex items-center">
                    <span className="text-2xl font-bold text-green-700">inHerbisVeritas</span>
                  </Link>
                </div>
                
                <nav className="hidden md:flex space-x-8">
                  <Link href="/magazine" className="text-gray-700 hover:text-green-600">Magazine</Link>
                  <Link href="/" className="text-gray-700 hover:text-green-600">Boutique</Link>
                  <Link href="/events" className="text-gray-700 hover:text-green-600">Événements</Link>
          ...
          <footer className="bg-gray-800 text-white">
            <div className="container mx-auto px-4 py-12">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/shop" className="text-gray-300 hover:text-white">Boutique</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>25 rue des Plantes, 75014 Paris</li>
                  <li>contact@inherbisveritas.fr</li>
              ...
              <div>
                ...
                <p className="text-gray-300 mb-4">Inscrivez-vous pour recevoir nos dernières actualités et offres spéciales.</p>
                <form className="flex">
                  <input
                    type="email"
            ...
            <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-300">
              <p>&copy; {new Date().getFullYear()} inHerbisVeritas. Tous droits réservés.</p>
            </div>
          </div>
        </footer>
      </div>
